...
const VideoDashboard_1 = __importDefault(require("@/components/VideoDashboard"));
function Room() {
    ...
    return (<div className="flex h-dvh flex-col justify-between  p-5">
      ...
      {remoteSocketId && (<VideoDashboard_1.default remoteSocketId={remoteSocketId} whiteboardID={whiteboardID}/>)}
