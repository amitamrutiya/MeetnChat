  ...
  return (
    <Html lang="en" dir="ltr">
      <Head>
        ...
        <header className="my-6 flex items-center justify-center align-middle font-sans text-xl font-bold antialiased">
      ...
      <Section>
        ...
        <Row>
          <Text>
            Thank you for registering on MeetNChillChat. Please use the following verification code to complete your
            registration:
          </Text>
        </Row>
        <Row>
